...
import { BaseApi, orderPerPage, sellerOrders, updateOrders } from '@/constants';
...
export default function OrdersPage() {
  ...
  let { data, error, isLoading, mutate } = useSWR(
    `${BaseApi}${sellerOrders}/${st?.user?.id}?date=${date}&status=${status}&courior=${courier}&page=${page}&limit=${orderPerPage}`,
    fetcher,
    {
