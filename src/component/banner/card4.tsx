...
const Card4 = ({ data, onDelete, onTemperoryDelete }: any) => {
  ...
  return (
    <div className="m-2 rounded-lg border border-gray-300 p-5">
      <div className="flex flex-row justify-end gap-5">
        ...
        <RecyclePopover
          title={`Recycle Delete the Banner`}
          description={`Are you sure you want to recycle delete this banner?`}
          onDelete={() => onTemperoryDelete(data?.id)}
        />

        <DeletePopover
          title={`Permanently Delete the Banner`}
          description={`Are you sure you want to permanently delete this banner?`}
